<template><p>相信我！下面这两个一定是IDEA必备的插件。</p>
<h2 id="key-promoter-x-快捷键提示" tabindex="-1"><a class="header-anchor" href="#key-promoter-x-快捷键提示" aria-hidden="true">#</a> Key Promoter X:快捷键提示</h2>
...
<p><img src="https://guide-blog-images.oss-cn-shenzhen.aliyuncs.com/idea/Key-Promoter-X1.png" alt="" loading="lazy"></p>
...
<p><img src="https://guide-blog-images.oss-cn-shenzhen.aliyuncs.com/idea/Key-Promoter-X2.png" alt="" loading="lazy"></p>
...
<h2 id="presentation-assistant-快捷键展示" tabindex="-1"><a class="header-anchor" href="#presentation-assistant-快捷键展示" aria-hidden="true">#</a> Presentation Assistant:快捷键展示</h2>
...
<p><img src="@source/idea-plugins/pictures/Presentation-Assistant.png" alt="" loading="lazy"></p>
